...
order_items!:CartItem[]
  ...
  ngOnInit(): void {
    ...
    console.log(this.customerService.cartItems)
    this.userAddress(this.user_id);
    this.order_items=this.customerService.cartItems
    ...
    this.customerService.getCartItems().subscribe(
      { next:(data)=>{
          ...
          console.log("Cart Data obtained: ",this.order_items);
